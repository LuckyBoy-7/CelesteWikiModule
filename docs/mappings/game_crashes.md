...
* [解决方案 1](https://saplonily.top/celeste_common_issues/index.html){:target="_blank"}
* [解决方案 2](https://github.com/EverestAPI/Resources/wiki/Common-Crashes){:target="_blank"}

你可以先尝试自己解决, 如果解决方案没有提及, 那么你可以

* 在 [Celeste Discord](https://discord.gg/6qjaePQ){:target="_blank"} 中搜索 log.txt 中的关键词
