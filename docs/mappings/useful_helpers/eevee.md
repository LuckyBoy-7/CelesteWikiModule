...
* Force Standard Behavior: 是否适配容器内的一些特殊实体, 如果勾选则会在某些操作时统一使用一个行为, 即不适配, 如果不勾选则会适配, 比如在[视频](https://www.bilibili.com/video/BV1kR8jzyEwV)中我们把水搬走的时候如果不做适配就会出问题, 但有时候不做适配产生的奇异搞笑的效果也可能是我们想要的(
...
* Ignore Anchors: 是否忽略锚点, 有的实体的运动会基于空间中的一个锚点, 比如弹球, 所以容器会在移动对象的同时移动锚点, 如果你不想对锚点进行操作可开启此项, 虽然也能用来做些[有趣的效果](https://www.bilibili.com/video/BV1XJ8JzKEsk/)
...
* [Easing](https://easings.net/): 将均匀变化的时间映射到不均匀变化的运动上, 以实现各种先快后慢, 先慢后快的运动 
...
为容器内实体添加抛接物的特性, 先来看看[西西弗斯](https://www.bilibili.com/video/BV13iLGz3ELu)(
...
你可以观看[视频](https://www.bilibili.com/video/BV1SchwzEEYJ/)来简单感受下他们是如何运作的
