...
* 详细的信息: 别惜字如金, 能提供越多清晰详细信息越好, 当然如果双方都在线的话, 后续直接一问一答也行(但如果你真的提供了足够详细的信息, 别人一般是能直接给出解决方案的)
    ...
    * 截图
        ...
        * `Shift + Win徽标键 + S`截屏
    * [log.txt](https://saplonily.top/celeste_common_issues/index.html#logtxt): 存放了游戏的调试信息, 方便在游戏崩溃时向群友求助, 但不能只发 log 而不作任何描述, 除非是很简单的 log, 不然难以判断是Helper的问题, 还是你自己的问题, 想帮你的人会红温的😡
* 谦卑的语气: 请问...你好...
