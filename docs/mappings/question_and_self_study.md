...
<p>我发现回答别人问题也是一种 wordle, 只是有时候别人回复的太慢导致游戏体验很差(每次在这里狂喷几十行结果每次都是睡醒后又无感然后删掉, 随他去吧)</p>
</details>
...
话疏了嗷(log 是很牛逼, 但是你别连话都不会说了, 报错前在干嘛, 可能是是什么操作导致的报错能不能顺便提一嘴😡)
