...
### [滤镜制作](https://www.bilibili.com/video/BV1WW7czqEPi){:target="_blank"}
...
如果你觉得这还是太吃操作了, 建议你使用[滤镜生成工具 / Celeste Colorgrade Generator](https://lostinnowhere314.github.io/celeste-colorgrade-gen/){:target="_blank"}: 生成完毕将图像另存为即可, 但我感觉还是感觉像 WEG 这样调符合直觉一点
